function S3MultiUpload(file) {
    ...
    this.SERVER_LOC = 'upload/'; // Location of the server
...
S3MultiUpload.prototype.uploadParts = function() {
    ...
    for (var i = 0; i < blobs.length; i++) {
        blob = blobs[i];
        promises.push(this.uploadXHR[i]=$.post(this.SERVER_LOC+'part', {
            command: 'part',
